...
void SamplingThread::run(){
    // Your code.
       ...
       std::string face_detect_path = "C:\\swproject\\screenMirrorTest\\model\\face_detection.onnx";
       std::string landmark_path = "C:\\swproject\\screenMirrorTest\\model\\landmark_detection.onnx";
