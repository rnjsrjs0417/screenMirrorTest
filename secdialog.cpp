...
void SecDialog::gotTodo(int res){
    ...
    ui->pushButton_4->setText(net->todo[0].c_str());
    ui->pushButton_5->setText(net->todo[1].c_str());
    ui->pushButton_6->setText(net->todo[2].c_str());
    ui->pushButton_7->setText(net->todo[3].c_str());
    ui->pushButton_8->setText(net->todo[4].c_str());
    //ui->pushButton_9->setText(QString::fromStdString(net->todo[5]));
}
...
void SecDialog::gotWeather(int res){
    ...
    if((int)net->rain > 70) // rainy
    {
        QPixmap pix("C:\\Users\\Kwon Geon\\Documents\\GitHub\\screenMirrorTest\\weather3.png");
        ui->label_pic->setPixmap(pix.scaled(w,h,Qt::KeepAspectRatio));
     }
    else if ((int)net->rain >= 30) // cloudy
    {
        QPixmap pix("C:\\Users\\Kwon Geon\\Documents\\GitHub\\screenMirrorTest\\weather2.png");
        ui->label_pic->setPixmap(pix.scaled(w,h,Qt::KeepAspectRatio));
     }
    else if ((int)net->rain >= 20) // little cloudy
    {
    ...
    {
        QPixmap pix("C:\\Users\\Kwon Geon\\Documents\\GitHub\\screenMirrorTest\\weather1.png");
        ui->label_pic->setPixmap(pix.scaled(w,h,Qt::KeepAspectRatio));
     }

    ui->temper->setText(QString::number((int)net->temp));
    ui->rain->setText(QString::number((int)net->rain));
    ui->humidity->setText(QString::number((int)net->humidity));
}
